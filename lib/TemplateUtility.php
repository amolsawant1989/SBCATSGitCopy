...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        echo '<tr>', "\n";
        echo '<td rowspan="2"><img src="images/SBC-smaller.png" width="250px" height="75px" border="0" alt="SBCATS" /></td>', "\n";
        echo '</tr>', "\n";
        echo '</table>', "\n";
    ...
    public static function printTabs($active, $subActive = '', $forceHighlight = '')
    {
        ...
        foreach ($modules as $moduleName => $parameters)
        {
            ...
            if (empty($tabText)|| $tabText === 'Lists' || $tabText === 'Contacts'|| $tabText === 'Calendar')
            {
                continue;
            }
			...
			if ($tabText == 'Job Orders')
            {
                $tabText = 'Job Listings';
            }
			...
			if ($tabText == 'Activities')
            {
                $tabText = 'Logs';
            }

			if ($tabText == 'Candidates')
            {
                $tabText = 'Candidates';
            }
			
			if ($tabText == 'Companies')
            {
                $tabText = 'Companies';
            }
    ...
    private static function _printCommonHeader($pageTitle, $headIncludes = array())
    {
        ...
        echo '<head>', "\n";
        echo '<title>SBCATS - ', $pageTitle, '</title>', "\n";
