...
class Mailer
{
        ...
        $signature = false)
    {
        ...
        if ($isHTML)
        {
            ...
            if ($signature)
            {
                $body .= "\n<br />\n<br /><span style=\"font-size: 10pt;\">Powered by <a href=\"http://www.searchbourne.com\" alt=\"SBCATS "
                    . "Applicant Tracking System\">SBCATS</a></span>";
            }
        ...
        else
        {
            if ($signature)
            {
                $body .= "\n\nPowered by SBCATS (http://www.searchbourne.com)";
            }
