...
<?php if ($this->multipleFilesEnabled): ?>
    ...
    <?php if ($this->uploadPath !== false): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        In order to import resume documents into SBCATS, you need to create a directory named "<b>upload</b>" on the computer
        that hosts SBCATS. This directory needs to have its permissions set to allow files to be created by your
        web server.
        <br /><br />
        ...
        <blockquote>
        <span style="color: #c0c0c0;">&gt;</span> Create a folder named <b>upload</b> in the directory you installed SBCATS.<br />
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <td align="left" valign="top">
                <span style="font-size: 16px;">
                <?php if (LicenseUtility::isProfessional()): ?>
                amolsawant1989@gmail.com You are a registered resfly user.
                ...
                <?php if ((is_array($status = LicenseUtility::getParsingStatus()) && $status['parseLimit'] == -1)): ?>
                    ...
                    and resume information. SBCATS will import all applicable resume documents as candidates.
                    </span>
                <?php else: ?>
                    <span style="font-size: 14px; color: #333333;">
