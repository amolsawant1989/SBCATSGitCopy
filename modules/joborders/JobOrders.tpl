...
<?php TemplateUtility::printHeader('Job Listings', array( 'js/highlightrows.js',  'js/sweetTitles.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
    ...
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->totalJobOrders ? ' style="background-color: #E6EEFF; padding: 0;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    <td width="3%">
                        <img src="images/job_orders.gif" width="24" height="24" border="0" alt="Job Listings" style="margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Job Listings: Home</h2></td>
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyJobOrders">Only My Job Listings</label>&nbsp;
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyHotJobOrders">Only Hot Job Listings</label>&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </form>
            ...
            <?php if ($this->totalJobOrders): ?>
            <p class="note">
                <span style="float:left;">Job Listings  -
