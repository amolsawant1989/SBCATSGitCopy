        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Job Listings: Add Job Listing</h2></td>
                </tr>
            </table>

            <p class="note">Add a new job Listing to the ATS.</p>
            ...
            <?php else: ?>
                <form name="addJobOrderForm" id="addJobOrderForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=add" method="post" onsubmit="return checkAddForm(document.addJobOrderForm);" autocomplete="off">
                    ...
                    <table class="editTable" width="80%">
                    		    <tr><td align="center"><h3><font color="#FF0000">*</font> Fields Mandatory</h3></td></tr>
                        <tr>
                            <td class="tdVertical">
                                <label id="titleLabel" for="title">Job Title:</label>
                            </td>
                            <td class="tdData">
                                <input type="text" tabindex="1" class="inputbox" id="title" name="title" style="width: 150px;" <?php if(isset($this->jobOrderSourceRS['title'])): ?>value="<?php $this->_($this->jobOrderSourceRS['title']); ?>"<?php endif; ?> />&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                            </td>
                        ...
                        <tr>
                            <td class="tdVertical">
                                <label id="companyIDLabel" for="companyID">Select Company:</label>
                            </td>
                            ...
                            <td class="tdData">
                                ...
                                <?php if ($this->defaultCompanyID !== false): ?>
                                    ...
                                    <input type="text" name="companyName" id="companyName" tabindex="2" value="<?php if ($this->selectedCompanyID !== false) { $this->_($this->companyRS['name']); } ?><?php if(isset($this->jobOrderSourceRS['companyName']) && $this->selectedCompanyID == false ): ?><?php $this->_($this->jobOrderSourceRS['companyName']); ?><?php endif; ?>" class="inputbox" style="width: 125px" onFocus="suggestListActivate('getCompanyNames', 'companyName', 'CompanyResults', 'companyID', 'ajaxTextEntryHover', 0, '<?php echo($this->sessionCookie); ?>', 'helpShim');" <?php if ($this->selectedCompanyID !== false) { echo('disabled'); } ?>/>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                                <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="tdData">
                                ...
                                <?php endif; ?>
                                </select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="tdData">
                                ...
                                <?php else: ?>
                                    <input type="text" tabindex="4" class="inputbox" id="city" name="city" style="width: 150px;" />&nbsp;</select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>

                                <?php endif; ?>
                            </td>

                                                        <td class="tdVertical">
                                <label id="salaryLabel" for="salary">Salary Range:</label>
                            </td>
                            <td class="tdData">
                        ...
                        <tr>
                            ...
                            <td class="tdData">
                                <?php if ($this->selectedCompanyID !== false): ?>
                                    <input type="text" tabindex="5" class="inputbox" id="state" name="state" value="<?php $this->_($this->selectedCompanyLocation['state']); ?>" style="width: 150px;" />&nbsp;</select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>

                                <?php else: ?>
                                    <input type="text" tabindex="5" class="inputbox" id="state" name="state" style="width: 150px;" />&nbsp;</select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="tdData">
                                <input type="text" tabindex="14" class="inputbox" id="openings" name="openings" style="width: 150px;" <?php if(isset($this->jobOrderSourceRS['openings'])): ?>value="<?php $this->_($this->jobOrderSourceRS['openings']); ?>"<?php else: ?>value="1"<?php endif; ?>/>&nbsp;</select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                            </td>
                        </tr>

                        <tr>
                            <td class="tdVertical">
                                <label id="recruiterLabel" for="recruiter">Recruiter Name:</label>
                            </td>
                            <td class="tdData">
                                <select tabindex="6" id="recruiter" name="recruiter" class="inputbox" style="width: 150px;">
                                    ...
                                    <?php foreach ($this->usersRS as $rowNumber => $usersData): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>&nbsp;</select>&nbsp;<font color="#FF0000" style="font-size:22px">*</font>
                            </td>
               ...
               <input type="text" tabindex="15" class="inputbox" id="companyJobID" name="companyJobID" style="width: 150px;" >
                        ...
                        <tr>
                            ...
                            <td class="tdVertical" style="visibility:hidden">
                                <label id="isHotLabel" for="isHot">Hot:</label>
                            </td>
                            <td class="tdData" style="visibility:hidden">
                    ...
                    <table class="editTable" width="90%">
                        ...
                        <tr>
                            <td class="tdVertical">
                                <label id="descriptionLabel" for="description">Job Description:</label>
                            </td>
                            <td class="tdData">
                    ...
                    <input type="submit" tabindex="20" class="button" name="submit" value="Add Job Listing" />&nbsp;
                    <input type="reset"  tabindex="21" class="button" name="reset"  value="Reset" />&nbsp;
                    <input type="button" tabindex="22" class="button" name="back"   value="Back to Job Listings" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=listByView');" />
                </form>
