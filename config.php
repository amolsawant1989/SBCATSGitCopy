 ...
 */
define('ANTIWORD_PATH', "C:\\antiword\\bin\\antiword64.exe");
 ...
 */
define('CAREERS_OWNERAPPLY_SUBJECT', 'SBCATS - A Candidate Has Applied to Your Job Order');
 ...
 */
define('FORGOT_PASSWORD_FROM_NAME', 'SBCATS');
define('FORGOT_PASSWORD_SUBJECT',   'SBCATS - Password Retrieval Request');
define('FORGOT_PASSWORD_BODY',      'You recently requested that your SBCATS: Applicant Tracking System password be sent to you. Your current password is %s.');
